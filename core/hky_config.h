#ifndef HKY_CONFIG_H_INCLUDED
#define HKY_CONFIG_H_INCLUDED
...
//加载系统头文件
#include "hky_sys_header.h"

/*
判断加载的配置文件
*/
#if(HKY_FREEBSD)
#include "../unix/hky_freebsd_config.h"
#elif (HKY_LINUX)
#include "../unix/hky_linux_config.h"
#elif (HKY_SOLARIS)
#include "../unix/hky_solaris_config.h"
#elif (HKY_DARWIN)
#include "../unix/hky_darwin_config.h"
#elif (HKY_WIN32)
#include "../unix/hky_darwin_config.h"
#else
#include "../unix/hky_posix_config.h"
#endif
