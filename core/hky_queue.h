#ifndef HKY_QUEUE_H_INCLUDED
#define HKY_QUEUE_H_INCLUDED
...
#define hky_queue_data(q,type,link)						\
		(type*)((hky_uchar*)q-offsetof(type,link))

hky_queue_t *hky_queue_middle(hky_queue_t *queue);
void hky_queue_sort(hky_queue_t *queue,
	hky_int_t(*cmp)(const hky_queue_t *, const hky_queue_t *));


#endif // !HKY_QUEUE_H_INCLUDED
