...
void
hky_rbtree_insert_timer_value(hky_rbtree_node_t *temp,hky_rbtree_node_t *node,hky_rbtree_node_t *sentinel){
hky_rbtree_node_t  **p;
...
hky_rbtree_left_rotate(hky_rbtree_node_t **root,
        hky_rbtree_node_t *sentinel, hky_rbtree_node_t *node){
...
static hky_inline void
hky_rbtree_right_rotate(hky_rbtree_node_t **root,
        hky_rbtree_node_t *sentinel, hky_rbtree_node_t *node){
         hky_rbtree_node_t  *temp;
